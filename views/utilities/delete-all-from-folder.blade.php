    ...
    <div class="col col-12 col-lg-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-muted">Укажите ID родительского документа и скрипт удалит всех его потомков</h6>
                <form action="{{ route('generator::utilities.deletechildrens') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="util-delete-all_parent_id" name="util-delete-all_parent_id" value="{{ old('util-delete-all_parent_id','') }}">
    ...
    <div class="col col-12 col-lg-4">
        <div class="card h-100">
            <div class="card-body">
                ...
                <h6 class="card-subtitle mb-2 text-muted">Скрипт создаёт документы с заданными pagetitle в указанной папке с выбранным шаблоном</h6>
                <form action="{{ route('generator::utilities.massadd') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="util-mass-add_parent_id" name="util-mass-add_parent_id" value="{{ old('util-mass-add_parent_id','') }}">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="util-mass-add_template" name="util-mass-add_template">
                            @foreach($templates as $item)
                                <option @if(old('util-mass-add_template', '') == $item->id) selected @endif value="{{ $item->id }}">{{ $item->id . ' - ' . $item->templatename }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="util-mass-add_pagetitles" name="util-mass-add_pagetitles" rows="5">{{ old('util-mass-add_pagetitles','') }}</textarea>
